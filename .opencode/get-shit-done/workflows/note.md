...
- **Global scope**: `/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/notes/`)
...
2. Glob `/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/notes/` — works in any directory

...
- Usage: Reference from command with `@/Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/nunamzza/projects/trading/openclaw-trading-agents/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
